...
void cmd_the_guide(void) {
	...
	while (TRUE) {
		...
		case '?': //help
			...
			Term_putstr( 0,  4, -1, TERM_L_BLUE, " Space/n,p,Enter,Back; s,d,D/f,S,c,# srch,nxt,prv,reset,chapter,line; ESC exits");
			...
			Term_putstr( 0, 12, -1, TERM_WHITE, "  'c'         :    Chapter Search. This is a special search that will skip most");
			Term_putstr( 0, 13, -1, TERM_WHITE, "                   basic text and only match specific topics and keywords.");
			Term_putstr( 0, 14, -1, TERM_WHITE, "                   Use this when searching for races, classes, skills, spells,");
			Term_putstr( 0, 15, -1, TERM_WHITE, "                   schools, techniques, dungeons, bosses, events, lineages,");
			Term_putstr( 0, 16, -1, TERM_WHITE, "                   depths, stair types, or actual chapter titles or indices.");
			Term_putstr( 0, 17, -1, TERM_WHITE, "  '#'         :    Jump to a specific line number.");
			Term_putstr( 0, 18, -1, TERM_WHITE, "  ESC         :    The Escape key will exit the guide screen.");
			Term_putstr( 0, 19, -1, TERM_WHITE, "In addition, the arrow keys and the number pad keys can be used, and the keys");
			Term_putstr( 0, 20, -1, TERM_WHITE, "PgUp/PgDn/Home/End should work both on the main keyboard and the number pad.");
			Term_putstr( 0, 21, -1, TERM_WHITE, "This might depend on your specific OS flavour and desktop environment though.");
			Term_putstr(24, 23, -1, TERM_L_BLUE, "(Press any key to go back)");
			inkey();
			continue;
