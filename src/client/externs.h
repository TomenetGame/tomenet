...
extern void resize_main_window_sdl3(int cols, int rows);
extern bool ask_for_bigmap(void);
extern void get_term_main_font_name(char *buf);
extern void animate_palette(void);
extern void set_palette(byte c, byte r, byte g, byte b);
...
extern void refresh_palette(void);
extern int get_misc_fonts(char *output_list, int max_misc_fonts, int max_font_name_length, int max_fonts);
extern void set_window_title_sdl3(int term_idx, cptr title);
...
extern char *SDL3_USER_PATH, *SDL3_GAME_PATH;
extern char SDL3_PATH_SEP[2];
extern bool sdl3_paths_same(cptr path1, cptr path2);
...
extern bool sdl3_window_decorations;
extern int sdl3_graphics_image_force_outline;
#endif
...
extern void clear_force_from_to(int row_s, int row_e);
...
#ifdef USE_SDL3
extern bool sdl3_ensure_parent_dirs(const char *path);
...
extern void prt_ac(int ac, bool boosted, bool unknown);
...
extern void prt_bpr_wraith_prob(byte bpr, byte attr, cptr bpr_str);
...
extern void prt_indicator_probtravel(bool is_active);
...
/* main-sdl3.c */
extern void all_term_data_to_term_prefs(void);
extern errr sdl3_win_term_main_screenshot(cptr name);
 #ifdef USE_GRAPHICS
extern bool sdl3_graphics_pref_file_processed();
...
extern bool sdl3_tileset_preview_ready(void);
extern void sdl3_tileset_preview_draw_tile(int col, int row, int type, char32_t tile_char, char32_t background_char);
extern bool sdl3_set_graphics_mode(byte mode);
extern bool sdl3_reload_graphics_tileset(void);
extern bool sdl3_apply_graphics_resize_type(int value);
  #ifdef GRAPHICS_BG_MASK
extern bool sdl3_apply_graphics_image_force_outline(int value);
  #endif
 #endif
#endif
...
extern void enable_readability_blue_sdl3(void);
 #else
...
extern int cfg_soundpack_subset, cfg_musicpack_subset;
extern int soundpack_subsets, musicpack_subsets;
//extern char soundpack_description[AUDIO_SUBSETS_MAX + 1][MAX_CHARS * 3], soundpack_packname[AUDIO_SUBSETS_MAX + 1][MAX_CHARS];
extern char musicpack_description[AUDIO_SUBSETS_MAX + 1][MAX_CHARS * 3], musicpack_packname[AUDIO_SUBSETS_MAX + 1][MAX_CHARS];
