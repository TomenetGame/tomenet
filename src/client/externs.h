...
extern char location_name2[MAX_CHARS];
...
extern int music_cur, music_cur_song, music_next, music_next_song, weather_channel, weather_current, weather_channel_volume, ambient_channel, ambient_current, ambient_channel_volume;
