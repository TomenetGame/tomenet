...
int music_cur = -1, music_cur_song = -1, music_next = -1, music_next_song = -1, weather_channel = -1, weather_current, weather_channel_volume = 0, ambient_channel = -1, ambient_current, ambient_channel_volume = 0;
