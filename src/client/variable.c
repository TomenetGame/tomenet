...
int music_cur = -1, music_cur_song = -1, music_next = -1, weather_channel = -1, weather_current;
int weather_particles_seen, weather_sound_change, weather_fading;
bool cfg_audio_master = TRUE, cfg_audio_music = TRUE, cfg_audio_sound = TRUE, cfg_audio_weather = TRUE, weather_resume = FALSE;
...
generic_term_info term_prefs[10] = {
	{ 1, 0, 0, 80, 24, "8x13" },//TomeNET
	{ 1, 20, 20, 80, 24, "6x10" },//Mirror
	{ 1, 40, 40, 80, 24, "6x10" },//Recall
	{ 1, 60, 60, 80, 22, "5x8" },//Choice
	{ 1, 80, 80, 80, 17, "6x10" },//Term-4
	{ 1, 100, 100, 80, 14, "5x8" },//Term-5
	{ 0, 0, 0, 80, 24, "5x8" },
	{ 0, 0, 0, 80, 24, "5x8" },
	{ 0, 0, 0, 80, 24, "5x8" },
	{ 0, 0, 0, 80, 24, "5x8" }
...
char monster_list_name[MAX_R_IDX][40], monster_list_symbol[MAX_R_IDX][2];
