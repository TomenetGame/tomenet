	...
	while (TRUE) {
		...
		/* get object from backup file */
			...
			case 1: r = fread(o_ptr_v2, sizeof(object_type_v2), 1, fp);
				...
				o_ptr->find_dun = 0;
				o_ptr->find_player_id = o_ptr->find_player_turndiff = 0;
			...
			case 6: r = fread(o_ptr_v5, sizeof(object_type_v5), 1, fp);
				...
				o_ptr->find_player_id = 0;//o_ptr_v5->find_player;
			...
			case 7: r = fread(o_ptr_v6, sizeof(object_type_v6), 1, fp);
				...
				o_ptr->find_player_id = 0;//o_ptr_v6->find_player;
			...
			case 8: r = fread(o_ptr_v7, sizeof(object_type_v7), 1, fp);
				...
				o_ptr->find_player_id = 0;//o_ptr_v7->find_player;
			...
			case 9: r = fread(o_ptr_v8, sizeof(object_type_v8), 1, fp);
				...
				o_ptr->find_player_id = 0;//o_ptr_v8->find_player;
			...
			case 10: r = fread(o_ptr_v9, sizeof(object_type_v9), 1, fp);
				...
				o_ptr->find_player_id = 0;//o_ptr_v9->find_player;
...
int similar_names(const char *name1_raw, const char *name2_raw) {
	...
	if ((ptr3 = roman_suffix(name1, NULL))) *(ptr3 - 1) = 0;
	if ((ptr3 = roman_suffix(name2, NULL))) *(ptr3 - 1) = 0;
