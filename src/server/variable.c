...
s32b opening_chest;             /* Hack -- prevent chest generation */
byte opening_chest_mode;        /* Hack -- prevent chest generation */
...
server_opts cfg =
{
	...
	8,1,TRUE,	// maxhouses = 50/_houses_per_player_, castles_per_player, castles_for_kings
