...
//extern bool central_town_loaded;
...
extern bool project_hook(int Ind, int typ, int dir, int dam, int flg, char attacker[80]);
extern bool project(int who, int rad, struct worldpos *wpos, int y, int x, int dam, int typ, int flg, char attacker[80]);
