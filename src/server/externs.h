...
extern char priv_note[MAX_NOTES][MSG_LEN], priv_note_sender[MAX_NOTES][NAME_LEN], priv_note_target[MAX_NOTES][NAME_LEN], priv_note_u[MAX_NOTES][MSG_LEN], priv_note_date[MAX_NOTES][11];
...
extern void get_outward_target(int Ind, int *x, int *y, int maxdist, bool skip_sleeping, bool skip_friendly);
