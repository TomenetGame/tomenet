...
extern char *k_name;
extern char *k_text;
extern u16b k_info_num[MAX_K_IDX], tr_info_rev[MAX_T_IDX];
...
extern s16b brand_dam_aux(int Ind, object_type *o_ptr, int tdam, monster_type *m_ptr, bool thrown);
extern s16b brand_dam_aux_player(int Ind, object_type *o_ptr, int tdam, player_type *p_ptr, bool thrown);
