...
extern s32b player_exp_SLOWER[PY_MAX_LEVEL + 1];
...
extern bool logreenery(struct worldpos *wpos, int y1, int x1, int y2, int x2);
...
extern void do_set_mycorrhiza(int Ind, int item);
...
extern void update_players(void);
extern int place_monster_aux(struct worldpos *wpos, int y, int x, int r_idx, bool forbid_ego, bool slp, bool grp, int clo, int clone_summoning);
...
#endif
extern int alloc_monster(struct worldpos *wpos, int dis, int slp);
extern int alloc_monster_specific(struct worldpos *wpos, int r_idx, int dis, int slp);
extern int summon_specific(struct worldpos *wpos, int y1, int x1, int lev, int s_clone, int type, int allow_sidekicks, int clone_summoning);
extern int summon_specific_race(struct worldpos *wpos, int y1, int x1, int r_idx, int s_clone, unsigned char num);
#ifdef DM_MODULES
extern int summon_detailed_race(struct worldpos *wpos, int y1, int x1, int r_idx, int e_idx, int s_clone, unsigned char size);
#endif
extern int summon_specific_race_somewhere(struct worldpos *wpos, int r_idx, int s_clone, unsigned char num);
