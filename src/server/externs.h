...
extern void chat_to_irc(uint32_t id, char *text);
...
extern void add_player_name(cptr name, int id, u32b account, byte race, byte class, byte mode, byte level, u16b party, byte guild, u32b guild_flags, u16b quest, time_t laston);
...
extern int name_lookup_loose(int Ind, cptr name, u16b party, bool include_account_names);
extern int name_lookup_loose_quiet(int Ind, cptr name, u16b party, bool include_account_names);
extern int name_lookup(int Ind, cptr name, u16b party, bool include_account_names);
extern int name_lookup_quiet(int Ind, cptr name, u16b party, bool include_account_names);
