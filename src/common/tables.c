...
{ T_CLOU, "cloud", 10,  5, 20, 0,  0,  0,  0,  1, 163, 2,  2,  6, 10 }, // |  163 |  135 |  228 |  190 |  244 |  202 | Storm is +50% dps for much lower cost than a maximized cloud, with 2.0x duration and a fixed radius of 1. Might see more use by hybrids; more applicable than frost barrier for most elements.
{ T_SIGN, "sign",  15,  5, 20, 7, 10, 13, 20, 10, 100, 2,  2, 20, 45 }, // |      |      |      |      |  N/A |  N/A | Radius for Disarm is 1-4, Illumination is 5-11 (identical to Istari). Bolt damage matches stone-to-mud. Annihilation is -50% dps compared to the wand, 720 to Morgy/uniques, 2400 cap to PowerD/N/etc (better than flare if it hits).
{ T_BALL, "ball",  20,  5, 15, 0,  0,  0,  0, 21, 519, 2,  3,  0,  0 }, // |  519 [  432 ]  726 [  605 ]  951 [  792 ] Fireflash(r4): 430vs432 pre MP, 594vs605 post MP, 792(usually less)vs792(inefficient) to Morgy, 1188vs605*2 suscept cap. OrbofDraining(r3): 367, 734 to Morgy
{ T_WAVE, "wave",  25, 10, 25, 0,  0,  0,  0, 30, 240, 6, 10,  0,  0 }, // |  240 |  200 |  336 |  280 |  120 |  100 | 105 damage (up to 6 ticks) for mana surge compared to power staff (400), base elements are equivalent.
{ T_GLPH, "glyph", 30, 25, 25, 0,  0,  0,  0, 10, 100, 0,  0,  0,  0 }, // |  259 |  216 |  363 |  302 |  N/A |  N/A |
