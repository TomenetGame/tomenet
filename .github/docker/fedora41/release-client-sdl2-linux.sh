...
STAGE_DIR="${RELEASE_STAGE_BASE}/client-sdl2-linux"
ROOT_NAME="tomenet-${RELEASE_VERSION}-client-sdl2-linux-${RELEASE_ARCH}"
ROOT_DIR="${STAGE_DIR}/${ROOT_NAME}"
ARCHIVE_PATH="${RELEASE_OUTDIR}/tomenet-${RELEASE_VERSION}-client-sdl2-linux-${RELEASE_ARCH}.tar.bz2"

make -C "$SRC_DIR" -f makefile.sdl2 clean tomenet
