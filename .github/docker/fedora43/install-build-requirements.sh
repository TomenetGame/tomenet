...
# On Fedora 43, libSDL2-2.0.so.0 comes from sdl2-compat and dlopens libSDL3.so.0 at runtime, so libSDL3.so.0 must also be available next to the bundled linux client.
#
