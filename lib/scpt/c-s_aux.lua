-- $Id$
-- Client side functions to help with spells, do not touch
--
-- This was separated from s_aux.lua b/c of different handling of
-- Players[]/player struct (see get_level).
-- If you devise a nice hack let's integrate them :)	- Jir -
