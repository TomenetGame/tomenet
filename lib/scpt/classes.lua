...
"Archer",
    {"\255uArchers\255U are to ranged combats what warriors",
    "are to melee brawls. No class deals more damage in",
...
"Paladin",
    {"\255uPaladins\255U are holy warriors, who can utilize",
    "divine magic much like priests. They primarily use",
...
"Ranger",
    ...
    "same as warriors and rogues may do.",
    "Devoted to nature, they will avoid foul magic such",
    "as necromancy, but are skilled at trapping, magic",
    "devices, saving throw, stealth, searching, and",
    "perception. At level 15 rangers learn to pass",
    "through thick woods unhindered, and at 25 they are",
    "already very able swimmers as well.",},

"Adventurer",
    {"\255uAdventurers\255U are the most versatile of all",
    "classes. However, while they can train almost any",
    "skill, and do not possess any specific strengths",
    "or weaknesses, they also do not excel at anything",
    "in particular in turn. The size of their mana pool",
    "depends on wisdom and intelligence in equal parts.",
    "They are often hybrids combining features of other",
    "more distinct classes in one character, creating",
    "unusual mixtures of abilities and synergies.",
    "They can be hard to play for beginners, because",
    "it can be hard to decide and find out what to do",
    "when faced with an overwhelming amount of skills.",},

"Druid",
    {"\255uDruids\255U are able to call upon the mystic",
    "powers of nature. Their wisdom is their primary",
    "stat for spell-casting and they train Martial Arts",
    "to complement this in close quarters, where they",
    "shapeshift into various animals and hybrids to",
    "make use of their strengths as fits the situation.",
    "Unlike mimics, druids learn their forms on every 5",
    "levels, without having to kill those monsters. A",
    "special ability of druids is that they can wear",
...
"Runemaster",
    {"\255uRunemasters\255U use arcane symbols known as runes",
    "to summon pure elemental magic. They use dexterity",
...
"Mindcrafter",
    {"\255uMindcrafters\255U are calm warriors who have",
    "trained their mind to utilize psychic powers. They",
    "have a variety of spells of most different nature,",
    "be it a psionic blast that fries the opponent's",
    "brain, or a telepathic overtake that lets him see",
