...
school_book[17] = { FOCUSSHOT, HERBALTEA, QUICKFEET, HEALINGCLOUD_III, EXTRASTATS_II, }
...
if (def_hack("TEMP2", nil)) then
	...
	--school_book[22] = { DETECTINVIS, POISONRES, OFEAR_II, OBLIND_II, OSLEEP_II, SHADOWGATE, OINVIS, CHAOSBOLT, NETHERBOLT, POISONFOG_III, DARKBOLT_III, ODRAINLIFE, ODARKBALL } --shadow/ENABLE_DEATHKNIGHT
	school_book[22] = { DETECTINVIS, POISONRES, OFEAR_II, OBLIND_II, OSLEEP_II, SHADOWGATE, OINVIS, CHAOSBOLT, NETHERBOLT, DARKBOLT_III, ODRAINLIFE, ODARKBALL } --shadow/ENABLE_DEATHKNIGHT
	school_book[23] = { ODELFEAR, TRANCE, DETECTCREATURES, POSSESS, STOPPOSSESS, STARLIGHT_II, OCURSEDD_III, OLIGHTNINGBOLT_III, LITEBEAM_III, ODELCURSES_II, GUARDIANSPIRIT_II } --spirit

	-- Create the Occult book Hereticism
	if (def_hack("TEMP3", nil)) then
		school_book[24] = { TERROR_II, FIREBOLT_III, FIRERES, HCHAOSBOLT, SAPLIFE, HFIRESTORM, BLOODSACRIFICE } --ENABLE_HELLKNIGHT
	end
end
...
--	ICESTORM_II, HELLFIRE_II, FIREBALL_II, SHAKE, DISEBOLT, THUNDERSTORM, HORBDRAIN, HDRAINCLOUD
	TIDALWAVE_II, HELLFIRE_II, FIREBALL_II, STRIKE_II, DISEBOLT, CHAOSBOLT, THUNDERSTORM, HORBDRAIN_II, HDRAINCLOUD
}
else
school_book[55] = {
--	ICESTORM_II, HELLFIRE_II, FIREBALL_II, SHAKE, DISEBOLT, THUNDERSTORM, HORBDRAIN, HDRAINCLOUD
...
if (def_hack("TEMP2", nil)) then
	--include Occult Shadow spells
	school_book[61] = { OCURSEDD_I, ODELFEAR, STARLIGHT_I, OFEAR_I, DETECTINVIS, HDETECTEVIL, SENSEHIDDEN_I }
else
