...
school_book[1] = { GLOBELIGHT_II, RESISTS_II, FIERYAURA_II, FIREBOLT_III, FIREWALL_II, FIREFLASH_III, }
-- The book of the blowing winds (9-13)
school_book[2] = { AIRWINGS, POISONBLOOD, RESISTS_II, THUNDERSTORM, NOXIOUSCLOUD_III, INVISIBILITY, LIGHTNINGBOLT_III, }
-- The book of the impenetrable earth (14-17)
school_book[3] = {
--	STONESKIN, DIG, STONEPRISON, SHAKE, STRIKE_II,
	DIG, STONEPRISON, RESISTS_II, SHAKE, STRIKE_II, ACIDBOLT_III,
}
