...
school_book[0] = { MANATHRUST_III, DELCURSES_II, RESISTS, MANASHIELD, }
-- The book of the eternal flame (5-8)
school_book[1] = { GLOBELIGHT_II, FIREBOLT_III, FIREFLASH_III, FIERYAURA_II, FIREWALL_II, }
-- The book of the blowing winds (9-13)
school_book[2] = { NOXIOUSCLOUD_III, LIGHTNINGBOLT_III, POISONBLOOD, INVISIBILITY, AIRWINGS, THUNDERSTORM, }
-- The book of the impenetrable earth (14-17)
school_book[3] = {
--	STONESKIN, DIG, STONEPRISON, SHAKE, STRIKE_II,
	DIG, ACIDBOLT_III, STONEPRISON, SHAKE, STRIKE_II,
}
-- The book of the everrunning wave (18-21)
school_book[4] = { VAPOR_III, FROSTBOLT_III, WATERBOLT_III, ENTPOTION, TIDALWAVE_II, ICESTORM_II, }
-- Create the book of translocation (22-27)
school_book[5] = { DISARM, BLINK, TELEPORT, TELEAWAY_II, RECALL, PROBABILITY_TRAVEL, }
-- Create the book of the tree * SUMMONANIMAL requires pets first (28-32)
school_book[6] = { GROWTREE, HEALING_III, RECOVERY_II, REGENERATION, VERMINCONTROL, }
-- Create the book of Knowledge (33-38)
school_book[7] = { DETECTMONSTERS, SENSEHIDDEN_II, REVEALWAYS, IDENTIFY_III, VISION_II, STARIDENTIFY, }
-- Create the book of the Time (39-42)
school_book[8] = { MAGELOCK_II, SLOWMONSTER_II, ESSENSESPEED, MASSWARP, }
-- Create the book of meta spells (43-45)
school_book[9] = { RECHARGE_III, PROJECT_SPELLS, DISPERSEMAGIC, }
-- Create the book of the mind * CHARM requires pets first (46-48)
school_book[10] = { CONFUSE_II, STUN_II, TELEKINESIS, SENSEMONSTERS, }
-- Create the book of hellflame * DRAIN, FLAMEOFUDUN missing (49-53)
school_book[11] = { GENOCIDE_I, GENOCIDE_II, WRAITHFORM, DISEBOLT, HELLFIRE_II, STOPWRAITH, }

-- Priests / Paladins:

-- Create the book of Holy Offense (54-60)
if (def_hack("TEST_SERVER", nil)) then
school_book[12] = { HCURSE_III, HGLOBELIGHT_II, HORBDRAIN_II, HDRAINLIFE, HEXORCISM_II, HRELSOULS_III, HDRAINCLOUD, HCURSEDD, }
else
school_book[12] = { HCURSE_III, HGLOBELIGHT_II, HORBDRAIN_II, HDRAINLIFE, HEXORCISM_II, HRELSOULS_III, HDRAINCLOUD, }
end
-- Create the book of Holy Defense (61-65)
school_book[13] = { HBLESSING_III, HRESISTS_III, HPROTEVIL, HRUNEPROT, HMARTYR, }
-- Create the book of Holy Curing (66-72)
school_book[14] = { HCUREWOUNDS_II, HHEALING_III, HDELCURSES_II, HHEALING2_III, HCURING_III, HRESTORING, HSANITY, HRESURRECT, HDELBB, }
-- Create the book of Holy Support (73-79)
school_book[15] = { HDELFEAR, HGLOBELIGHT_II, HDETECTEVIL, HSENSEMON, HSANCTUARY_II, HSATISFYHUNGER, HSENSE_II, HZEAL_III, }
...
school_book[23] = { TRANCE, DETECTCREATURES, POSSESS, STOPPOSSESS, STARLIGHT_II, OCURSEDD_III, OLIGHTNINGBOLT_III, LITEBEAM_III, } --spirit
end
...
school_book[51] = {
--	NOXIOUSCLOUD_III, AIRWINGS, THUNDERSTORM, FIREFLASH_III, FIREWALL_II, TIDALWAVE_II, ICESTORM_II, SHAKE
	NOXIOUSCLOUD_III, AIRWINGS, THUNDERSTORM, FIREFLASH_III, FIERYAURA_II, VAPOR_III, ICESTORM_II, SHAKE
}
...
school_book[55] = {
--	ICESTORM_II, HELLFIRE_II, FIREFLASH_III, SHAKE, DISEBOLT, THUNDERSTORM, HORBDRAIN, HDRAINCLOUD
	TIDALWAVE_II, HELLFIRE_II, FIREFLASH_III, STRIKE_II, DISEBOLT, THUNDERSTORM, HORBDRAIN_II, HDRAINCLOUD
}
...
if (def_hack("TEST_SERVER", nil)) then
	--include Occult Shadow spells
	school_book[61] = { HDELFEAR, MANATHRUST_I, HCURSE_I, GLOBELIGHT_I, DETECTMONSTERS, HDETECTEVIL, HSANCTUARY_I, SENSEHIDDEN_I, DETECTCREATURES }
else
	school_book[61] = { HDELFEAR, MANATHRUST_I, HCURSE_I, GLOBELIGHT_I, DETECTMONSTERS, HDETECTEVIL, HSANCTUARY_I, SENSEHIDDEN_I }
end
