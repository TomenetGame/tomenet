...
if (def_hack("TEMP2", nil)) then
	...
	if (def_hack("TEMP3", nil)) then
		...
		school_book[24] = { TERROR_II, ODELFEAR2, OFIREBOLT_III, FIRERES, FLAMEWAVE_II, OEXTRASTATS, CHAOSBOLT2, ORESTORING, LEVITATION, HATE, FIRESTORM, BLOODSACRIFICE } --ENABLE_HELLKNIGHT
	end
end
