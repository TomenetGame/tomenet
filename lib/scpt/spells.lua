...
--	ICESTORM, HELLFIRE, FIREFLASH, SHAKE, DISEBOLT, THUNDERSTORM, HORBDRAIN, HDRAINCLOUD
	TIDALWAVE, HELLFIRE, FIREFLASH, STRIKE, DISEBOLT, THUNDERSTORM, HORBDRAIN_II, HDRAINCLOUD
}
...
school_book[59] = { IDENTIFY, STARIDENTIFY, SENSEHIDDEN, DETECTMONSTERS, SENSEMONSTERS, MSELFKNOW, MSANITY, HDETECTEVIL, MSENSEMON, MIDENTIFY }
...
school_book[61] = { HDELFEAR, MANATHRUST, HCURSE_I, GLOBELIGHT, DETECTMONSTERS, HDETECTEVIL, HSANCTUARY_I, SENSEHIDDEN }
