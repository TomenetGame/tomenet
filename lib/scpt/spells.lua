...
school_book[1] = { GLOBELIGHT_II, FIREBOLT_III, FIREFLASH_III, FIERYAURA_II, FIREWALL, }
...
school_book[4] = { VAPOR_III, FROSTBOLT_III, WATERBOLT_III, ENTPOTION, TIDALWAVE, ICESTORM_II, }
...
school_book[51] = {
--	NOXIOUSCLOUD_III, AIRWINGS, THUNDERSTORM, FIREFLASH_III, FIREWALL, TIDALWAVE, ICESTORM_II, SHAKE
...
--	ICESTORM_II, HELLFIRE_II, FIREFLASH_III, SHAKE, DISEBOLT, THUNDERSTORM, HORBDRAIN, HDRAINCLOUD
	TIDALWAVE, HELLFIRE_II, FIREFLASH_III, STRIKE_II, DISEBOLT, THUNDERSTORM, HORBDRAIN_II, HDRAINCLOUD
}
