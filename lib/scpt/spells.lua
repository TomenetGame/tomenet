...
school_book[2] = { THUNDERSTORM, AIRWINGS, RESISTS_II, INVISIBILITY, NOXIOUSCLOUD_III, VAPORMIRROR, LIGHTNINGBOLT_III, HAILSTORM }
-- The book of the impenetrable earth (14-17)
school_book[3] = {
--	STONESKIN, DIG, STONEPRISON, SHAKE, STRIKE_II,
	DIG, RESISTS_II, STONEPRISON, STRIKE_II, SPIKES, ACIDBOLT_III, RIFT, SHAKE
}
-- The book of the everrunning wave (18-21)
school_book[4] = { ENTPOTION, RESISTS_II, VAPORMIRROR, TIDALWAVE_II, ICESTORM_II, VAPOR_III, FROSTBOLT_III, WATERBOLT_III, FROSTBALL_II, HAILSTORM }
...
--	NOXIOUSCLOUD_III, THUNDERSTORM, AIRWINGS, FIREBALL_II, FIREWALL_II, TIDALWAVE_II, ICESTORM_II, SHAKE
	NOXIOUSCLOUD_III, THUNDERSTORM, AIRWINGS, RESISTS_II, FIERYAURA_II, VAPOR_III, ICESTORM_II, SHAKE, FROSTBALL_II, FIREBALL_II, HAILSTORM
}
...
school_book[55] = { TIDALWAVE_II, HELLFIRE_II, FIREBALL_II, SHAKE, THUNDERSTORM, HDRAINCLOUD, EARTHQUAKE, CHAOSBOLT, CHAOSBOLT2, FLAMEWAVE_II, NETHERBOLT, RIFT, HAILSTORM } --todo: possibly add OUNLIFE spells, maybe to other books too
...
school_book[64] = { THUNDERSTORM, AIRWINGS, TIDALWAVE_I, VAPOR_II, LIGHTNINGBOLT_II, ICESTORM_I, FROSTBALL_I, FROSTBOLT_II, WATERBOLT_II, VAPORMIRROR, HAILSTORM }
...
school_book[67] = { TIDALWAVE_I, VAPOR_II, FIREWALL_I, MANATHRUST_II, LIGHTNINGBOLT_II, FROSTBOLT_II, WATERBOLT_II, ACIDBOLT_II, FIREBOLT_II, HELLFIRE_I, FROSTBALL_I, FIREBALL_I, SPIKES, HAILSTORM }
