...
if (def_hack("TEST_SERVER", nil)) then
school_book[19] = {MDISARM, MBLINK, MTELEPORT, MTELETOWARDS, MPYROKINESIS, MCRYOKINESIS, MTELEAWAY, MTELEKINESIS, MFUSION,}
...
school_book[19] = {
	MBASH, MDISARM, MBLINK, MTELEPORT, MTELETOWARDS, MPSISTORM, MPYROKINESIS, MCRYOKINESIS, MTELEAWAY, MTELEKINESIS,
}
