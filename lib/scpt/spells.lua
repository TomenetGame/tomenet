...
school_book[1] = { RESISTS_II, GLOBELIGHT_II, FIERYAURA_II, FIREBOLT_III, FIREWALL_II, FIREFLASH_III, }
-- The book of the blowing winds (9-13)
school_book[2] = { AIRWINGS, RESISTS_II, POISONBLOOD, THUNDERSTORM, NOXIOUSCLOUD_III, INVISIBILITY, LIGHTNINGBOLT_III, }
...
school_book[4] = { ENTPOTION, RESISTS_II, TIDALWAVE_II, ICESTORM_II, VAPOR_III, FROSTBOLT_III, WATERBOLT_III, }
...
school_book[22] = { DETECTINVIS, OBLIND_II, OSLEEP_II, SHADOWGATE, OINVIS, DARKBOLT_III, ODRAINLIFE_II, } --shadow
...
--	NOXIOUSCLOUD_III, AIRWINGS, THUNDERSTORM, FIREFLASH_III, FIREWALL_II, TIDALWAVE_II, ICESTORM_II, SHAKE
	NOXIOUSCLOUD_III, AIRWINGS, RESISTS_II, THUNDERSTORM, FIREFLASH_III, FIERYAURA_II, VAPOR_III, ICESTORM_II, SHAKE
}
...
if (def_hack("TEMP2", nil)) then
	...
	school_book[57] = { BLINK, OBLIND_II, DETECTINVIS, SENSEHIDDEN_II, REVEALWAYS, VISION_II, OINVIS, INVISIBILITY }
else
