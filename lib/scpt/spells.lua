...
if (def_hack("TEMP2", nil)) then
	...
	school_book[23] = { ODELFEAR, MEDITATION, TRANCE, DETECTCREATURES, POSSESS, STOPPOSSESS, STARLIGHT_II, OCURSEDD_III, OLIGHTNINGBOLT_III, LITEBEAM_III, ODELCURSES_II, GUARDIANSPIRIT_II, RITES_II } --spirit
