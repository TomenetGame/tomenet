...
if (def_hack("TEMP2", nil)) then
	...
	if (def_hack("TEMP3", nil)) then
		--school_book[24] = { TERROR_II, FIREBOLT_III, FIRERES, CHAOSBOLTH, SAPLIFE, FIRESTORM, BLOODSACRIFICE } --ENABLE_HELLKNIGHT
		school_book[24] = { TERROR_II, ODELFEAR2, FIREBOLT_III, FIRERES, OEXTRASTATS, CHAOSBOLT2, ORESTORING, LEVITATION, FIRESTORM, BLOODSACRIFICE } --ENABLE_HELLKNIGHT
	end
end
