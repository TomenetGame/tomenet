...
school_book[21] = { MSCARE_II, MCONFUSE_II, MSLEEP_II, MSLOWMONSTER_II, MPSISTORM_II, MMINDBLAST_III, MSILENCE, MIDENTIFY, MMAP, MCHARM_III, MSTOPCHARM, }

-- Create the Occult books:

school_book[22] = { OBLIND_I, DETECTINVIS, POISONRES, OBLINK, OFEAR_II, OBLIND_II, OLEVITATION, OSLEEP_II, SHADOWGATE, OINVIS, CHAOSBOLT, DISPERSION, STOPDISPERSION, ODRAINLIFE, DARKBOLT_III, DARKBALL } --shadow/ENABLE_DEATHKNIGHT
school_book[23] = { ODELFEAR, MEDITATION, TRANCE, STARLIGHT_II, POSSESS, STOPPOSSESS, DETECTCREATURES, ODELCURSES_II, OCURSEDD_III, OLIGHTNINGBOLT_III, LITEBEAM_III, GUARDIANSPIRIT_II, RITES_II } --spirit
