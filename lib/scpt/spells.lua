...
school_book[2] = { AIRWINGS, POISONBLOOD, THUNDERSTORM, NOXIOUSCLOUD_III, INVISIBILITY, LIGHTNINGBOLT_III, }
-- The book of the impenetrable earth (14-17)
school_book[3] = {
--	STONESKIN, DIG, STONEPRISON, SHAKE, STRIKE_II,
	DIG, STONEPRISON, SHAKE, STRIKE_II, ACIDBOLT_III,
}
-- The book of the everrunning wave (18-21)
school_book[4] = { ENTPOTION, TIDALWAVE_II, ICESTORM_II, VAPOR_III, FROSTBOLT_III, WATERBOLT_III, }
...
if (def_hack("TEST_SERVER", nil)) then
school_book[12] = { HGLOBELIGHT_II, HCURSE_III, HDRAINLIFE, HORBDRAIN_II, HEXORCISM_II, HRELSOULS_III, HDRAINCLOUD, HCURSEDD, }
else
school_book[12] = { HGLOBELIGHT_II, HCURSE_III, HDRAINLIFE, HORBDRAIN_II, HEXORCISM_II, HRELSOULS_III, HDRAINCLOUD, }
end
-- Create the book of Holy Defense (61-65)
school_book[13] = { HPROTEVIL, HBLESSING_III, HRUNEPROT, HRESISTS_III, HMARTYR, }
...
school_book[17] = { FOCUSSHOT, HERBALTEA, QUICKFEET, HEALINGCLOUD, EXTRASTATS_II, }
