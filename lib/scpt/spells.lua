...
school_book[22] = { DETECTINVIS, OBLIND_I, POISONRES, OBLINK, OFEAR_II, OBLIND_II, OLEVITATION, OSLEEP_II, SHADOWGATE, OINVIS, CHAOSBOLT, DISPERSION, STOPDISPERSION, DARKBOLT_III, ODRAINLIFE, DARKBALL } --shadow/ENABLE_DEATHKNIGHT
...
school_book[24] = { TERROR_II, ODELFEAR2, FIRERES, OFIREBOLT_III, FLAMEWAVE_II, OEXTRASTATS, RAGE_II, CHAOSBOLT2, ORESTORING, LEVITATION, FIRESTORM, BLOODSACRIFICE } --ENABLE_HELLKNIGHT
