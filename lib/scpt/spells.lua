...
school_book[51] = {
--	NOXIOUSCLOUD_III, AIRWINGS, THUNDERSTORM, FIREBALL_II, FIREWALL_II, TIDALWAVE_II, ICESTORM_II, SHAKE
	NOXIOUSCLOUD_III, AIRWINGS, RESISTS_II, THUNDERSTORM, FIERYAURA_II, VAPOR_III, ICESTORM_II, SHAKE, FROSTBALL_II, FIREBALL_II
}
