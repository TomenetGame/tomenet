...
school_book[22] = { DETECTINVIS, OFEAR_II, OBLIND_II, OSLEEP_II, SHADOWGATE, OINVIS, CHAOSBOLT, NETHERBOLT, DARKBOLT_III, ODRAINLIFE, ODARKBALL } --shadow/ENABLE_DEATHKNIGHT
...
if (def_hack("TEMP2", nil)) then
	--include Occult Shadow spells
	school_book[61] = { OCURSEDD_I, ODELFEAR, STARLIGHT_I, DETECTCREATURES, DETECTINVIS, HCURSE_I, HDETECTEVIL, SENSEHIDDEN_I }
else
