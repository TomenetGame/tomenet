...
"Draconian",
    {"\255uDraconians\255U are half-breeds of dragon and men",
    "who surpass humans in all ways, except they are",
    "really bad at moving stealthily. They are able to",
    "consume firestones to boost their powers and they",
    "have intrinsic telepathic vision which expands as",
    "they get stronger. They also acquire basic resis-",
    "tance, fire at 10, cold at 15, acid at 20, and",
    "lightning at 25. At 30 they learn how to fly.",
...
"Kobold",
    {"\255uKobolds\255U are somewhat smallish dog-faced",
    "humanoids who resist poison intrinsically. They",
    "are able to take most roles, being somewhat better",
    "at archery than close combat. Their intelligence",
    "is somewhat suspect and although they do not pick",
    "up careers as mages or other elaborate professions",
    "they can become shamans or druids.",
    "They have infra-vision, extraordinarily sharp",
    "senses and can move very silently. They are also",
    "good at disarming traps.",
    "Kobolds receive a bonus on Swimming and Trapping",
    "and a slight bonus on Sneakiness.",},

"Dark-Elf",
    {"\255uDark-elves\255U dwell below the surface in huge",
    "caverns of their underground city, living in a",
    "very peculiar society. The children are already",
    "drilled to become sworn enemies of most other",
    "races of the underground and also of the hated",
    "elves who dwell on the surface under the burning",
    "light of the sun. Overthrowing rivals by murder",
    "and treachery are acknowledged as long as noone",
    "is left alive to bring up charges. Dark-elves",
    "make good fighters and mages, but also decent",
    "priests. They resist darkness intrinsically,",
